...
const ViewSoftoQuotation = () => {
  ...
  const handleDownloadPDF = async (isPrint = false) => {
    try {
      setDownloading(true);
      console.log("🔄 Starting PDF download/preview...");

      const blob = await softoQuotationsService.generatePDF(id); // get PDF blob only once
      ...
      if (blob.size === 0) {
        alert("⚠️ Empty PDF file received.");
        return;
      }
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xl font-bold text-[#800000] mt-1">
                {formatCurrency(quotation.discountedPrice)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 mt-1">
                {quotation.salesPersonMobile || "N/A"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-900 mt-1">
                {formatDate(quotation.validFromDate)}
              </p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-500">
