    ...
    setTimeout(() => {
      setLeads([
        ...
        },
        {
          ...
          source: 'social_media',
          squareFeet: '2000',
          remark: 'Looking for mobile app development',
        ...
        },
        {
          ...
          source: 'referral',
          squareFeet: '1800',
          remark: 'E-commerce website needed',
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="text-gray-600">
          View and manage your leads. Track potential clients and their project requirements.
        </p>
      </div>
